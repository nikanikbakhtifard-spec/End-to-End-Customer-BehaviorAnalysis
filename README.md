...
2. Data Modelling & EDA (Python): Data cleaning, handling missing values, and exploratory analysis.
3. Data Analysis (SQL): Writing complex queries to extract specific behavioral patterns.
...
* [Customer_Shopping_Behavior_Analysis.ipynb](Customer_Shopping_Behavior_Analysis.ipynb): Python cleaning and EDA code.
* [customer_behavior_sql_queries.sql](customer_behavior_sql_queries.sql): SQL analysis scripts.
* [customer_behavior_dashboard.pbix](customer_behavior_dashboard.pbix): Interactive Power BI dashboard.
